...
Here we briefly introduce how to use our simplifier. First make sure that each AMR takes exactly one line in your file. Second, execute 
```
./anonDeAnon_java.sh anonymizeAmrFull true xxx
```
where 'xxx' is the path of your file.  As the result, 'xxx.anonymized' contains the simplified results.
